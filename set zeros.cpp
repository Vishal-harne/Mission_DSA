//to get more optio=mise solution we will going use the first row and column as marker 
//it will save our o(m+n) space and do in place replacement to get better solution
class Solution {
public:
